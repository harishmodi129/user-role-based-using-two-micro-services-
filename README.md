A project which provide permission based on role and using two micro services .One is auth-services and another is document-services. and both services use a common authentication to validate user
